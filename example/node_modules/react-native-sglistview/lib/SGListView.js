...
const { ListView, PropTypes, RefreshControl, ScrollView } = React;
const SGListViewCell = require('./SGListViewCell');
...
const SGListView = React.createClass({
  ...
  propTypes: {
    ...
    /**
     * Number of cells to preemptively render in front of the users scrolling
     */
    premptiveLoading: PropTypes.number,

    /** Should enable refresh control */
  ...
  onRefresh: function() {
    ...
    this.props.onPullToRefresh(this);
  },
  ...
  turnOnRefreshControl: function() {
    this.setState({isRefreshing: true});
  },

  turnOffRefreshControl: function() {
    const self = this;
