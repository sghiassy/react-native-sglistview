...
const SGListViewCell = React.createClass({
  ...
  render() {
    ...
    // Get style prop of view and pass it to SGListViewCell
    const hasStyle = this.props.usersView.props.style !== undefined;
    let style = {};
    if (hasStyle) {
      style = this.props.usersView.props.style;
      this.props.usersView.props.style = {};
    }
