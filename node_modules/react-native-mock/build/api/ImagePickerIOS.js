...
return _ImagePickerIOS2['default'].openCameraDialog(config,successCallback,cancelCallback);}return openCameraDialog;}(),
...
return _ImagePickerIOS2['default'].openSelectDialog(config,successCallback,cancelCallback);}return openSelectDialog;}()};
