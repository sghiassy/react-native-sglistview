...
gestureState._accountsForMovesUpTo=0;}return _initializeGestureState;}(),
...
gestureState._accountsForMovesUpTo=touchHistory.mostRecentTimeStamp;}return _updateGestureStateOnMove;}(),
...
config.onPanResponderReject&&config.onPanResponderReject(e,gestureState);}return onResponderReject;}(),
...
var touchHistory=e.touchHistory;
gestureState.numberActiveTouches=touchHistory.numberActiveTouches;
config.onPanResponderStart&&config.onPanResponderStart(e,gestureState);}return onResponderStart;}(),
...
// already processed multi-touch geometry during the first event.
PanResponder._updateGestureStateOnMove(gestureState,touchHistory);
config.onPanResponderMove&&config.onPanResponderMove(e,gestureState);}return onResponderMove;}(),


onResponderEnd:function(){function onResponderEnd(e){
var touchHistory=e.touchHistory;
gestureState.numberActiveTouches=touchHistory.numberActiveTouches;
config.onPanResponderEnd&&config.onPanResponderEnd(e,gestureState);}return onResponderEnd;}(),
