...
this.__onEnd=null;
onEnd&&onEnd(result);}return __debouncedOnEnd;}()}]);return Animation;}();var 
...
this.__active=false;
window.cancelAnimationFrame(this._animationFrame);
this.__debouncedOnEnd({finished:false});}return stop;}()}]);return SpringAnimation;}(Animation);var 
...
_this6._listeners={};return _this6;}_createClass(AnimatedValue,[{key:'__detach',value:function(){function __detach()
...
this._animation=null;
callback&&callback(this.__getValue());}return stopAnimation;}()
...
this._listeners[key]({value:this.__getValue()});}}return _updateValue;}()}]);return AnimatedValue;}(AnimatedWithChildren);
...
_this8._listeners={};return _this8;}_createClass(AnimatedValueXY,[{key:'setValue',value:function(){function setValue(
...
callback&&callback(this.__getValue());}return stopAnimation;}()},{key:'addListener',value:function(){function addListener(


callback){var _this9=this;
var id=String(_uniqueId++);
var jointCallback=function(){function jointCallback(_ref){var value=_ref.value;
callback(_this9.__getValue());}return jointCallback;}();
...
_this10._interpolation=interpolation;return _this10;}_createClass(AnimatedInterpolation,[{key:'__getValue',value:function(){function __getValue()
...
_this16._style=style;return _this16;}_createClass(AnimatedStyle,[{key:'__getValue',value:function(){function __getValue()
...
var maybeVectorAnim=function(){function maybeVectorAnim(value,config,anim){
...
return null;}return maybeVectorAnim;}();
...
traverse(recMapping[key],recEvt[key],key);}}return traverse;}();
